...
namespace Chiayin_Yang_Assignment3.Data
{
    public class InvoicesDbContext : DbContext
    {
        ...
        // Define a property to access the Invoices table in the DB:
        public DbSet<Customer> Customers { get; set; }
        public DbSet<Invoice> Invoices { get; set; }
        public DbSet<InvoiceLineItem> InvoicesLineItems { get; set; }
        public DbSet<PaymentTerms> PaymentTerms { get; set; }

        //override the OnModelCreating method to init our DB:
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            // use this as a place to seed the DB with some data
